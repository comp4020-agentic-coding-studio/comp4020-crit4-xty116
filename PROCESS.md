...
3. **Changing the interaction, not just its styling.** Grid feedback led to a harness for a linked, playable Piano Room ([`3df38da`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit4-xty116/commit/3df38da)) and its first direct-performance implementation ([`0e881ce`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit4-xty116/commit/0e881ce)). Further feedback exposed two compromises: its voice was electronic and its range stopped at 37 keys. I expanded the keybed to all 88 standard keys, added a mobile range navigator, and built Concert from detuned string partials, generated hammer noise, stereo position and pitch-dependent decay ([`b33accd`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit4-xty116/commit/b33accd)). Forty-five checks pass. Browser inspection confirmed A0/C8 endpoints, 52 white and 36 black keys, full-width internal scrolling, and no document overflow at 1440×900 or 390×844.
